//
//  ASHRAESaveAndShareViewController.swift
//  PreGeo
//
//  Created by Leon ZHANG on 17/05/2016.
//  Copyright © 2016 ZHANGLiangliang. All rights reserved.
//

import UIKit
import MessageUI
class ASHRAESaveAndShareViewController: UIViewController , MFMailComposeViewControllerDelegate, UIAlertViewDelegate{
    ...
    @IBAction func sendEmail(_ sender: UIButton) {
        let mailString = UserDefaults.standard.string(forKey: "saveASHRAEValues")
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            emailViewController.addAttachmentData(data!, mimeType: "text/csv", fileName: "ASHRAE Results.csv")
        }else{
