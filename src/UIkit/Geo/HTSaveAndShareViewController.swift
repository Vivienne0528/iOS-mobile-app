//
//  HTSaveAndShareViewController.swift
//  PreGeo
//
...
import UIKit
import MessageUI
class  HTSaveAndShareViewController: UIViewController , MFMailComposeViewControllerDelegate, UIAlertViewDelegate{
    ...
    @IBAction func sendEmail(_ sender: UIButton) {
        let mailString = UserDefaults.standard.string(forKey: "saveHTValues")
        print(mailString as Any)
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            emailViewController.addAttachmentData(data!, mimeType: "text/csv", fileName: "IGSHPAHT Results.csv")
        }else{
