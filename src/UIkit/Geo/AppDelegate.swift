...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let Bool = UserDefaults.standard
        let acceptBool = Bool.bool(forKey: "termAccepted")
        if acceptBool == true {
            initViewController = storyboard.instantiateViewController(withIdentifier: "SubMainNavigationController"/*storyboard id of your login controller*/) as UIViewController
