...
struct TermsAndConditionsView: View {
    ...
    Develper info:
     development team:
     Product owner: Ruiqi pang
     Scurm master: Yichen Liu
     Developer:Yuwei Gu, Yuntian Wan,
                        Haoyuan He

    About the app:
     This is a very efficient application for people who want to learn how to deploy pipelines or calculate the specific costs of deploying the underlying pipelines
    ...
    var body: some View {
        ScrollView {
            ...
            Text("terms_detail".localized(language))
                .padding(30)
        }
