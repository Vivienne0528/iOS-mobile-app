...
struct IGSHPAVBResultView: View {
    ...
    init(calculator: IGSHPAVBCalculation) {
        ...
        self.inputDataItems = [
            ...
            ResultDataItem(name: "T(G)", value: formatNumber(calculator.deepEarthTempearture), unit: calculator.tgUnit, units: ["℃", "℉"], convertFunction: convertTemperature),
    ...
    var body: some View {
        ...
        .sheet(isPresented: $sendEmail) {
            MailView(content: "Please see the attached details.".localized(language), to: email_Value, subject: "IGSHPA VB "+"Result".localized(language), image1: screenshot1, image2: screenshot2, image3: screenshot3)
        }
