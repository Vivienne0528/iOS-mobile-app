...
class IGSHPAHTCalculation: ObservableObject {
    ...
    @Published var tmUnit: Int = 0
    @Published var asUnit: Int = 0
    @Published var rsUnit: Int = 0
    ...
    @Published var dUnit: Int = 0
    @Published var smUnit: Int = 0
    @Published var pmUnit: Int = 0
