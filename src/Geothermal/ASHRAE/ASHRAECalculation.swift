...
class ASHRAECalculation: ObservableObject {
    ...
    @Published var cpUnit: Int = 0
    @Published var tInHpUnit: Int = 0
    @Published var mFlsUnit: Int = 0
    // Ground Properties Unit
    @Published var alphaUnit: Int = 0
    @Published var kUnit: Int = 0
    @Published var tgUnit: Int = 0
    @Published var qyUnit: Int = 0
    @Published var qmUnit: Int = 0
    @Published var qhUnit: Int = 0
    // Borehole Parameters Unit
    @Published var bUnit: Int = 0
    @Published var nbUnit: Int = 0
    @Published var aUnit: Int = 0
    @Published var rBoreUnit: Int = 0
    @Published var kGroutUnit: Int = 0
    @Published var luUnit: Int = 0
    @Published var rPinUnit: Int = 0
    @Published var rPextUnit: Int = 0
    @Published var kPipeUnit: Int = 0
    @Published var hConvUnit: Int = 0
